...
{
    public partial class frm9MaxTable : Form
    {
            ...
            foreach (HandPlayers hp in listHP)
            {
                ...
                switch (hp.Seat)
                {
                    ...
                    case 6:
                        ...
                        break;
                    case 7:
                        btn7.Visible = showButton;
                        p7.Text = player.Nickname + " - " + hp.InitialStack;
                        //border6.Visible = hp.Position == 3;
                        break;
                    case 8:
                        btn8.Visible = showButton;
                        p8.Text = player.Nickname + " - " + hp.InitialStack;
                        //border6.Visible = hp.Position == 3;
                        break;
                    case 9:
                        btn9.Visible = showButton;
                        p9.Text = player.Nickname + " - " + hp.InitialStack;
                        //border6.Visible = hp.Position == 3;
                        break;
                    default:                        
                        break;
        ...
        internal void SetHoleCards(double idHand)
        {
            ...
            listFirstCards[0].Add(7, "redCard");
            listFirstCards[0].Add(8, "redCard");
            listFirstCards[0].Add(9, "redCard");
            ...
            listSecondCards[0].Add(7, "redCard");
            listSecondCards[0].Add(8, "redCard");
            listSecondCards[0].Add(9, "redCard");
                ...
                if (card.IDPlayer > 0)
                {
                    switch (listHP.Find(x => x.IDPlayer == card.IDPlayer).Seat)
                    {
                        ...
                        case 6:
                            ...
                            break;
                        case 7:
                            if (p7c1.ImageLocation == @"Images\redCard.jpg")
                            {
                                p7c1.ImageLocation = @"Images\" + card.Card + ".jpg";
                                listFirstCards[0][7] = card.Card;
                            }
                            else
                            {
                                p7c2.ImageLocation = @"Images\" + card.Card + ".jpg";
                                listSecondCards[0][7] = card.Card;
                            }
                            break;
                        case 8:
                            if (p8c1.ImageLocation == @"Images\redCard.jpg")
                            {
                                p8c1.ImageLocation = @"Images\" + card.Card + ".jpg";
                                listFirstCards[0][8] = card.Card;
                            }
                            else
                            {
                                p8c2.ImageLocation = @"Images\" + card.Card + ".jpg";
                                listSecondCards[0][8] = card.Card;
                            }
                            break;
                        case 9:
                            if (p9c1.ImageLocation == @"Images\redCard.jpg")
                            {
                                p9c1.ImageLocation = @"Images\" + card.Card + ".jpg";
                                listFirstCards[0][9] = card.Card;
                            }
                            else
                            {
                                p9c2.ImageLocation = @"Images\" + card.Card + ".jpg";
                                listSecondCards[0][9] = card.Card;
                            }
                            break;
                        default:
                            break;
        ...
        internal void RunAction(Actions action)
        {
            ...
            if (OrderHand + 1 < listAction.Count())
            {
                ...
                border7.Visible = listHP.Find(y => y.IDPlayer == listAction[OrderToConsider].IDPlayer).Seat == 7;
                border8.Visible = listHP.Find(y => y.IDPlayer == listAction[OrderToConsider].IDPlayer).Seat == 8;
                border9.Visible = listHP.Find(y => y.IDPlayer == listAction[OrderToConsider].IDPlayer).Seat == 9;
            }
            ...
            if ((action.Action == -1) || (action.Action == 3) || (action.Action == 2))
            {
                ...
                switch (hp.Seat)
                {
                    ...
                    case 7:
                        if (bet7.Text != "")
                            bet7.Text = "$ " + (Convert.ToDouble(bet7.Text.Substring(2, bet7.Text.Length - 2)) + action.Value).ToString();
                        else
                            bet7.Text = "$ " + action.Value.ToString();
                        bet7.Visible = true;
                        p7.Text = player.Nickname + " - " + hp.InitialStack;
                        break;
                    case 8:
                        if (bet8.Text != "")
                            bet8.Text = "$ " + (Convert.ToDouble(bet8.Text.Substring(2, bet8.Text.Length - 2)) + action.Value).ToString();
                        else
                            bet8.Text = "$ " + action.Value.ToString();
                        bet8.Visible = true;
                        p8.Text = player.Nickname + " - " + hp.InitialStack;
                        break;
                    case 9:
                        if (bet9.Text != "")
                            bet9.Text = "$ " + (Convert.ToDouble(bet9.Text.Substring(2, bet9.Text.Length - 2)) + action.Value).ToString();
                        else
                            bet9.Text = "$ " + action.Value.ToString();
                        bet9.Visible = true;
                        p9.Text = player.Nickname + " - " + hp.InitialStack;
                        break;
                    default:
            ...
            if (action.Action == 1)
            {
                switch (hp.Seat)
                {
                    ...
                    case 6:
                        ...
                        break;
                    case 7:
                        p7c1.ImageLocation = @"Images\whiteCard.jpg";
                        p7c2.ImageLocation = @"Images\whiteCard.jpg";
                        break;
                    case 8:
                        p8c1.ImageLocation = @"Images\whiteCard.jpg";
                        p8c2.ImageLocation = @"Images\whiteCard.jpg";
                        break;
                    case 9:
                        p9c1.ImageLocation = @"Images\whiteCard.jpg";
                        p9c2.ImageLocation = @"Images\whiteCard.jpg";
                        break;
                    default:
                        break;
                }
        ...
        {            
            ...
            border7.Visible = nextHandPlayer.Seat == 7;
            border8.Visible = nextHandPlayer.Seat == 8;
            border9.Visible = nextHandPlayer.Seat == 9;
            ...
            if (action.Action == 1)
            {
                switch (hp.Seat)
                {
                    ...
                    case 6:
                        ...
                        break;
                    case 7:
                        p7c1.ImageLocation = @"Images\redCard.jpg";
                        p7c2.ImageLocation = @"Images\redCard.jpg";
                        break;
                    case 8:
                        p8c1.ImageLocation = @"Images\redCard.jpg";
                        p8c2.ImageLocation = @"Images\redCard.jpg";
                        break;
                    case 9:
                        p9c1.ImageLocation = @"Images\redCard.jpg";
                        p9c2.ImageLocation = @"Images\redCard.jpg";
                        break;
                    default:
                        break;
                }
            ...
            if (action.Action == 3 || action.Action == 2)
            {
                ...
                switch (hp.Seat)
                {
                    ...
                    case 6:
                        ...
                        break;
                    case 7:
                        previousBet = Convert.ToDouble(bet7.Text.Substring(2, bet7.Text.Length - 2));
                        if (previousBet == action.Value)
                        {
                            bet7.Visible = false;
                            bet7.Text = "";
                        ...
                        {
                            bet7.Text = "$ " + (previousBet - action.Value).ToString();
                            bet7.Visible = true;
                        }
                        p7.Text = player.Nickname + " - " + hp.InitialStack;
                        break;
                    case 8:
                        previousBet = Convert.ToDouble(bet8.Text.Substring(2, bet8.Text.Length - 2));
                        if (previousBet == action.Value)
                        {
                            bet8.Visible = false;
                            bet8.Text = "";
                        ...
                        {
                            bet8.Text = "$ " + (previousBet - action.Value).ToString();
                            bet8.Visible = true;
                        }
                        p8.Text = player.Nickname + " - " + hp.InitialStack;
                        break;
                    case 9:
                        previousBet = Convert.ToDouble(bet9.Text.Substring(2, bet9.Text.Length - 2));
                        if (previousBet == action.Value)
                        {
                            bet9.Visible = false;
                            bet9.Text = "";
                        ...
                        {
                            bet9.Text = "$ " + (previousBet - action.Value).ToString();
                            bet9.Visible = true;
                        }
                        p9.Text = player.Nickname + " - " + hp.InitialStack;
                        break;
            ...
            foreach (HandPlayers handPlayer in listHP)
            {
                ...
                switch (handPlayer.Seat)
                {
                    ...
                    case 6:
                        ...
                        break;
                    case 7:
                        p7.Text = player.Nickname + " - " + handPlayer.InitialStack;
                        listStacks[0][7] = handPlayer.InitialStack;
                        listNicknames[6] = player.Nickname;
                        break;
                    case 8:
                        p8.Text = player.Nickname + " - " + handPlayer.InitialStack;
                        listStacks[0][8] = handPlayer.InitialStack;
                        listNicknames[7] = player.Nickname;
                        break;
                    case 9:
                        p9.Text = player.Nickname + " - " + handPlayer.InitialStack;
                        listStacks[0][9] = handPlayer.InitialStack;
                        listNicknames[8] = player.Nickname;
                        break;
                    default:
                        break;
                }
        ...
        private void RunAction2(int orderHand)
        {
            ...
            if (orderHand != listAction.Count - 1)
            {
                ...
                else
                {
                    ...
                    border7.Visible = listBorders[orderHand][7];
                    border8.Visible = listBorders[orderHand][8];
                    border9.Visible = listBorders[orderHand][9];
                }
            }
            else
            {
            ...
            if (listStacks[orderHand].Count > 6)
                p7.Text = listNicknames[6] + " - " + listStacks[orderHand][7].ToString();
            if (listStacks[orderHand].Count > 7)
                p8.Text = listNicknames[7] + " - " + listStacks[orderHand][8].ToString();
            if (listStacks[orderHand].Count > 8)
                p9.Text = listNicknames[8] + " - " + listStacks[orderHand][9].ToString();
            ...
            bet7.Text = "$ " + listBets[orderHand][7].ToString();
            bet8.Text = "$ " + listBets[orderHand][8].ToString();
            bet9.Text = "$ " + listBets[orderHand][9].ToString();
            ...
            p7c1.ImageLocation = @"Images\" + listFirstCards[orderHand][7] + ".jpg";
            p8c1.ImageLocation = @"Images\" + listFirstCards[orderHand][8] + ".jpg";
            p9c1.ImageLocation = @"Images\" + listFirstCards[orderHand][9] + ".jpg";
            ...
            p7c2.ImageLocation = @"Images\" + listSecondCards[orderHand][7] + ".jpg";
            p8c2.ImageLocation = @"Images\" + listSecondCards[orderHand][8] + ".jpg";
            p9c2.ImageLocation = @"Images\" + listSecondCards[orderHand][9] + ".jpg";
            ...
            bet7.Visible = (bet7.Text != "$ 0");
            bet8.Visible = (bet8.Text != "$ 0");
            bet9.Visible = (bet9.Text != "$ 0");
        ...
        private void SetStates(int orderHand)
        {
            ...
            if (orderHand > 0)
            {
                ...
                listFirstCards[orderHand].Add(7, listFirstCards[orderHand - 1][7]);
                listFirstCards[orderHand].Add(8, listFirstCards[orderHand - 1][8]);
                listFirstCards[orderHand].Add(9, listFirstCards[orderHand - 1][9]);
                ...
                listSecondCards[orderHand].Add(7, listSecondCards[orderHand - 1][7]);
                listSecondCards[orderHand].Add(8, listSecondCards[orderHand - 1][8]);
                listSecondCards[orderHand].Add(9, listSecondCards[orderHand - 1][9]);
                ...
                if (listStacks[orderHand - 1].Count > 6)
                    listStacks[orderHand].Add(7, listStacks[orderHand - 1][7]);
                if (listStacks[orderHand - 1].Count > 7)
                    listStacks[orderHand].Add(8, listStacks[orderHand - 1][8]);
                if (listStacks[orderHand - 1].Count > 8)
                    listStacks[orderHand].Add(9, listStacks[orderHand - 1][9]);
            }
            ...
            if (bet7.Text == "")
                listBets[orderHand].Add(7, 0);
            else
                listBets[orderHand].Add(7, Convert.ToDouble(bet7.Text.Substring(2, bet7.Text.Length - 2)));
            if (bet8.Text == "")
                listBets[orderHand].Add(8, 0);
            else
                listBets[orderHand].Add(8, Convert.ToDouble(bet8.Text.Substring(2, bet8.Text.Length - 2)));
            if (bet9.Text == "")
                listBets[orderHand].Add(9, 0);
            else
                listBets[orderHand].Add(9, Convert.ToDouble(bet9.Text.Substring(2, bet9.Text.Length - 2)));
            ...
            if (orderHand != listAction.Count() - 1)
            {
                ...
                listBorders[orderHand].Add(7, nextHP.Seat == 7);
                listBorders[orderHand].Add(8, nextHP.Seat == 8);
                listBorders[orderHand].Add(9, nextHP.Seat == 9);
            }
                ...
                case 2:                    
                    ...
                    switch (hp.Seat)
                    {
                        ...
                        case 6:
                            ...
                            break;
                        case 7:
                            listBets[orderHand][7] = listBets[orderHand][7] + action.Value;
                            listStacks[orderHand][7] = listStacks[orderHand][7] - action.Value;
                            break;
                        case 8:
                            listBets[orderHand][8] = listBets[orderHand][8] + action.Value;
                            listStacks[orderHand][8] = listStacks[orderHand][8] - action.Value;
                            break;
                        case 9:
                            listBets[orderHand][9] = listBets[orderHand][9] + action.Value;
                            listStacks[orderHand][9] = listStacks[orderHand][9] - action.Value;
                            break;
                        default:
                            break;
                    }
                ...
                case 1:                    
                    switch (hp.Seat)
                    {
                        ...
                        case 6:
                            ...
                            break;
                        case 7:
                            listFirstCards[orderHand][7] = "whiteCard";
                            listSecondCards[orderHand][7] = "whiteCard";
                            break;
                        case 8:
                            listFirstCards[orderHand][8] = "whiteCard";
                            listSecondCards[orderHand][8] = "whiteCard";
                            break;
                        case 9:
                            listFirstCards[orderHand][9] = "whiteCard";
                            listSecondCards[orderHand][9] = "whiteCard";
                            break;
                        default:
                            break;
                    }
            ...
            if (listStacks[orderHand].Count > 6)
                listStacks[orderHand][7] = Math.Round(listStacks[orderHand][7], 2);
            if (listStacks[orderHand].Count > 7)
                listStacks[orderHand][8] = Math.Round(listStacks[orderHand][8], 2);
            if (listStacks[orderHand].Count > 8)
                listStacks[orderHand][9] = Math.Round(listStacks[orderHand][9], 2);
        }
    }
}
